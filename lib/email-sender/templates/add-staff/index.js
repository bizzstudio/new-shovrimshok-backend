...
<head>
    ...
    <title>הוספת עובד - ${process.env.COMPANY_NAME}</title>
    <style>
        body {
...
<body dir="rtl">
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="description">
                התקבלה בקשה להוסיף אותך כ${option.role === "Admin" ? "מנהל" : "עובד"} <strong>${option.role}</strong> בחברת <span style="text-transform: capitalize;"><strong>${option.cname}</strong></span>.
            </p>
            
            <p class="description">
                ראשית, אפס את הסיסמה שלך על ידי לחיצה על כפתור "איפוס סיסמה" למטה. לאחר מכן תוכל להתחבר לחשבון על ידי לחיצה על כפתור "התחברות".
            </p>
            
            <div style="text-align: center; margin: 30px 0;">
                <a href="https://${option.cname}.app-dev.dashter.com/reset-password/${option.token}" class="button button-primary">איפוס סיסמה</a>
                <a href="https://${option.cname}.app-dev.dashter.com/login" class="button button-secondary">התחברות</a>
            </div>
