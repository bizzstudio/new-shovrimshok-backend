// lib/email-sender/templates/forget-password/index.js
...
<head>
    ...
    <title>איפוס סיסמה - ${process.env.COMPANY_NAME}</title>
    <style>
        body {
...
<body dir="rtl">
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="description">
                התקבלה בקשה לשינוי הסיסמה לחשבון <strong>${process.env.COMPANY_NAME}</strong> שלך.
            </p>
            
            <p class="description">
                קישור זה יפוג בעוד <strong style="color: #f21e27;">15 דקות</strong>.
            </p>
            ...
            <div class="button-container">
                <a href="${process.env.STORE_URL}/user/forget-password/${option.token}" class="button">איפוס סיסמה</a>
            </div>
